...
in {
  ...
  programs.git = {
    ...
    settings = {
      ...
      # ── Aliases ─────────────────────────────────────────────────────────
      # Most aliases moved to fish abbreviations for better UX (expansion + completions)
      # Only keeping aliases that benefit from being git-native:
      alias = {
        # Pretty log formats (complex format strings are easier as git aliases)
        ...
        # Convenience aliases for common compound operations
        unstage = "reset HEAD";
