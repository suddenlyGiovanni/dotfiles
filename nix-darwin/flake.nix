      ...
      configuration =
        { pkgs, ... }:
        {
          ...
          environment.systemPackages = [
            pkgs.vim
            pkgs.nixd # nix lsp deamon
#            pkgs.nixfmt-rfc-style # nix lang formatter
#            pkgs.colima # Container runtimes with minimal setup
#            pkgs.awscli2 # Unified tool to manage your AWS services
#            pkgs.bat # A cat(1) clone with syntax highlighting and Git integration
#            pkgs.coreutils # The GNU Core Utilities
#            pkgs.docker # An open source project to pack, ship and run any application as a lightweight container
#            pkgs.docker-buildx # Docker CLI plugin for extended build capabilities with BuildKit
#            pkgs.lazydocker # A simple terminal UI for both docker and docker-compose
#            pkgs.docker-slim # Minify and secure Docker containers
#            pkgs.eza # A modern, maintained replacement for ls
#            pkgs.fd # A simple, fast and user-friendly alternative to find
#            pkgs.flyctl # Command line tools for fly.io services
...
#            pkgs.nushell # A modern shell written in Rust
#            pkgs.shellcheck # Shell script analysis tool
#            pkgs.shfmt # A shell parser and formatter
#            pkgs.starship # A minimal, blazing fast, and extremely customizable prompt for any shell
#            pkgs.weget # Tool for retrieving files using HTTP, HTTPS, and FTP
...
#              "grammarly" # Utility to fix grammar errors and style issues in text
