...
complete -c deno -n "__fish_seen_subcommand_from bundle" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from bundle" -s c -l config -d 'Load configuration file'
complete -c deno -n "__fish_seen_subcommand_from bundle" -l no-check -d 'Skip type checking modules'
complete -c deno -n "__fish_seen_subcommand_from bundle" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from cache" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from cache" -s c -l config -d 'Load configuration file'
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from compile" -s c -l config -d 'Load configuration file'
complete -c deno -n "__fish_seen_subcommand_from compile" -l no-check -d 'Skip type checking modules'
complete -c deno -n "__fish_seen_subcommand_from compile" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-read -d 'Allow file system read access'
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-write -d 'Allow file system write access'
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-net -d 'Allow network access'
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-env -d 'Allow environment access'
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-run -d 'Allow running subprocesses'
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-ffi -d 'Allow loading dynamic libraries'
complete -c deno -n "__fish_seen_subcommand_from compile" -l location -d 'Value of \'globalThis.location\' used by some web APIs'
complete -c deno -n "__fish_seen_subcommand_from compile" -l v8-flags -d 'Set V8 command line options (for help: --v8-flags=--help)'
complete -c deno -n "__fish_seen_subcommand_from compile" -l seed -d 'Seed Math.random()'
complete -c deno -n "__fish_seen_subcommand_from compile" -s o -l output -d 'Output file (defaults to $PWD/<inferred-name>)'
...
complete -c deno -n "__fish_seen_subcommand_from compile" -s h -l help -d 'Prints help information'
complete -c deno -n "__fish_seen_subcommand_from compile" -s V -l version -d 'Prints version information'
...
complete -c deno -n "__fish_seen_subcommand_from coverage" -s h -l help -d 'Prints help information'
complete -c deno -n "__fish_seen_subcommand_from coverage" -s V -l version -d 'Prints version information'
...
complete -c deno -n "__fish_seen_subcommand_from doc" -l import-map -d 'Load import map file'
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from eval" -s c -l config -d 'Load configuration file'
complete -c deno -n "__fish_seen_subcommand_from eval" -l no-check -d 'Skip type checking modules'
complete -c deno -n "__fish_seen_subcommand_from eval" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l seed -d 'Seed Math.random()'
...
complete -c deno -n "__fish_seen_subcommand_from fmt" -s c -l config -d 'Load configuration file'
...
complete -c deno -n "__fish_seen_subcommand_from fmt" -l options-line-width -d 'Define maximum line width. Defaults to 80.'
complete -c deno -n "__fish_seen_subcommand_from fmt" -l options-indent-width -d 'Define indentation width. Defaults to 2.'
...
complete -c deno -n "__fish_seen_subcommand_from info" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from info" -l import-map -d 'Load import map file'
...
complete -c deno -n "__fish_seen_subcommand_from install" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from install" -s c -l config -d 'Load configuration file'
complete -c deno -n "__fish_seen_subcommand_from install" -l no-check -d 'Skip type checking modules'
complete -c deno -n "__fish_seen_subcommand_from install" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from install" -l allow-ffi -d 'Allow loading dynamic libraries'
complete -c deno -n "__fish_seen_subcommand_from install" -l inspect -d 'Activate inspector on host:port (default: 127.0.0.1:9229)'
complete -c deno -n "__fish_seen_subcommand_from install" -l inspect-brk -d 'Activate inspector on host:port and break at start of user script'
complete -c deno -n "__fish_seen_subcommand_from install" -l location -d 'Value of \'globalThis.location\' used by some web APIs'
complete -c deno -n "__fish_seen_subcommand_from install" -l v8-flags -d 'Set V8 command line options (for help: --v8-flags=--help)'
complete -c deno -n "__fish_seen_subcommand_from install" -l seed -d 'Seed Math.random()'
...
complete -c deno -n "__fish_seen_subcommand_from uninstall" -s h -l help -d 'Prints help information'
complete -c deno -n "__fish_seen_subcommand_from uninstall" -s V -l version -d 'Prints version information'
...
complete -c deno -n "__fish_seen_subcommand_from lsp" -s h -l help -d 'Prints help information'
complete -c deno -n "__fish_seen_subcommand_from lsp" -s V -l version -d 'Prints version information'
...
complete -c deno -n "__fish_seen_subcommand_from lint" -s c -l config -d 'Load configuration file'
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from repl" -s c -l config -d 'Load configuration file'
complete -c deno -n "__fish_seen_subcommand_from repl" -l no-check -d 'Skip type checking modules'
complete -c deno -n "__fish_seen_subcommand_from repl" -s r -l reload -d 'Reload source code cache (recompile TypeScript)'
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l seed -d 'Seed Math.random()'
...
complete -c deno -n "__fish_seen_subcommand_from run" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from run" -s c -l config -d 'Load configuration file'
...
complete -c deno -n "__fish_seen_subcommand_from run" -l allow-ffi -d 'Allow loading dynamic libraries'
...
complete -c deno -n "__fish_seen_subcommand_from run" -l watch -d 'UNSTABLE: Watch for file changes and restart process automatically'
...
complete -c deno -n "__fish_seen_subcommand_from test" -l import-map -d 'Load import map file'
complete -c deno -n "__fish_seen_subcommand_from test" -s c -l config -d 'Load configuration file'
...
complete -c deno -n "__fish_seen_subcommand_from test" -l allow-ffi -d 'Allow loading dynamic libraries'
...
complete -c deno -n "__fish_seen_subcommand_from test" -l shuffle -d '(UNSTABLE): Shuffle the order in which the tests are run'
complete -c deno -n "__fish_seen_subcommand_from test" -l coverage -d 'UNSTABLE: Collect coverage profile data into DIR'
complete -c deno -n "__fish_seen_subcommand_from test" -s j -l jobs -d 'Number of parallel workers, defaults to # of CPUs when no value is provided. Defaults to 1 when the option is not present.'
