...
complete -c turbo -n "__fish_use_subcommand" -l scope -d 'DEPRECATED: Specify package(s) to act as entry points for task execution. Supports globs' -r
complete -c turbo -n "__fish_use_subcommand" -l ignore -d 'Files to ignore when calculating changed files from \'--filter\'. Supports globs' -r
complete -c turbo -n "__fish_use_subcommand" -l since -d 'DEPRECATED: Limit/Set scope to changed packages since a mergebase. This uses the git diff ${target_branch}... mechanism to identify which packages have changed' -r
...
complete -c turbo -n "__fish_use_subcommand" -l include-dependencies -d 'DEPRECATED: Include the dependencies of tasks in execution'
complete -c turbo -n "__fish_use_subcommand" -l no-deps -d 'DEPRECATED: Exclude dependent task consumers from execution'
...
complete -c turbo -n "__fish_seen_subcommand_from daemon; and not __fish_seen_subcommand_from restart; and not __fish_seen_subcommand_from start; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from stop; and not __fish_seen_subcommand_from clean; and not __fish_seen_subcommand_from logs" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from daemon; and not __fish_seen_subcommand_from restart; and not __fish_seen_subcommand_from start; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from stop; and not __fish_seen_subcommand_from clean; and not __fish_seen_subcommand_from logs" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from daemon; and __fish_seen_subcommand_from logs" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from daemon; and __fish_seen_subcommand_from logs" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and not __fish_seen_subcommand_from enable; and not __fish_seen_subcommand_from disable; and not __fish_seen_subcommand_from status" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and not __fish_seen_subcommand_from enable; and not __fish_seen_subcommand_from disable; and not __fish_seen_subcommand_from status" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from enable" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from enable" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from disable" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from disable" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from status" -l cpuprofile -d 'Specify a file to save a cpu profile' -r
...
complete -c turbo -n "__fish_seen_subcommand_from telemetry; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help'
...
complete -c turbo -n "__fish_seen_subcommand_from info" -l json
...
complete -c turbo -n "__fish_seen_subcommand_from run" -l scope -d 'DEPRECATED: Specify package(s) to act as entry points for task execution. Supports globs' -r
complete -c turbo -n "__fish_seen_subcommand_from run" -l ignore -d 'Files to ignore when calculating changed files from \'--filter\'. Supports globs' -r
complete -c turbo -n "__fish_seen_subcommand_from run" -l since -d 'DEPRECATED: Limit/Set scope to changed packages since a mergebase. This uses the git diff ${target_branch}... mechanism to identify which packages have changed' -r
...
complete -c turbo -n "__fish_seen_subcommand_from run" -l include-dependencies -d 'DEPRECATED: Include the dependencies of tasks in execution'
complete -c turbo -n "__fish_seen_subcommand_from run" -l no-deps -d 'DEPRECATED: Exclude dependent task consumers from execution'
